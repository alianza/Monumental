...
class ResultsSpinnerAdapter(context: Context, resource: Int) : ArrayAdapter<CharSequence>(
    context,
    resource
) {
    ...
    override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup): View {
        return initView(position, convertView, parent)
//        val view = LayoutInflater.from(parent.context).inflate(R.layout.spinner_item_save, null)
//        val tv = view.findViewById(R.id.tvLandmarkResultName) as TextView
//        val constraintLayout = view.findViewById(R.id.spinner_container) as ConstraintLayout
////        val btnSave = view.findViewById(R.id.btnSave) as ImageButton
////
////        if (v == null) {
