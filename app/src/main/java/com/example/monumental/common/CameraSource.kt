...
class CameraSource(private val activity: Activity, private val graphicOverlay: GraphicOverlay, private val resultsSpinnerAdapter: ArrayAdapter<CharSequence>) {
     ...
     */
    private val bytesToByteBuffer: MutableMap<ByteArray, ByteBuffer> =
        IdentityHashMap()
    // ==============================================================================================
    // Public
    // ==============================================================================================
    ...
    class SizePair {
        ...
        internal constructor(
            ...
            picture = if (pictureSize != null) Size(
                pictureSize.width,
                pictureSize.height
            ) else null
        }
    ...
    private fun setRotation(
        ...
        Log.d(
            TAG,
            "Display rotation is: $rotation"
        )
        Log.d(
            TAG,
            "Camera face is: " + cameraInfo.facing
        )
        Log.d(
            TAG,
            "Camera rotation is: " + cameraInfo.orientation
        )
        Log.d(
            TAG,
            "Rotation is: " + this.rotation
        )
    ...
    private fun createPreviewBuffer(previewSize: Size?): ByteArray {
        val bitsPerPixel =
            ImageFormat.getBitsPerPixel(IMAGE_FORMAT)
        val sizeInBits =
            previewSize!!.height.toLong() * previewSize.width * bitsPerPixel
